!(function(e, t) {
  ...
  var s = function(e, t) {
    ...
    N = function() {
      var e = p();
      (window.onkeydown = c.previousWindowKeyDown),
    ...
    _ = function(e) {
      ...
      var a = m(),
        ...
        u = k();
      if (
        ((a.innerHTML = e.title.split("\n").join("<br>")), e.text || e.html)
      ) {
        if ("object" === D(e.html))
          if (((l.innerHTML = ""), 0 in e.html))
            for (var d = 0; d in e.html; d++)
              l.appendChild(e.html[d].cloneNode(!0));
          else l.appendChild(e.html.cloneNode(!0));
        else
          e.html
            ? (l.innerHTML = e.html)
            : e.text && (l.innerHTML = ("" + e.text).split("\n").join("<br>"));
        L(l);
      } else q(l);
      e.showCloseButton ? L(u) : q(u),
        (t.className = n.modal),
      ...
      e.progressSteps.length
        ? (L(b),
          ...
          e.progressSteps.forEach(function(t, o) {
            ...
            if (
              (A(r, n.progresscircle),
              (r.innerHTML = t),
              o === S && A(r, n.activeprogressstep),
              b.appendChild(r),
      ...
      if (e.type) {
        ...
        switch ((L(H), e.type)) {
          case "success":
            A(H, "animate"),
              A(H.querySelector(".tip"), "animate-success-tip"),
              A(H.querySelector(".long"), "animate-success-long");
            break;
          case "error":
            A(H, "animate-error-icon"),
              A(H.querySelector(".x-mark"), "animate-x-mark");
            break;
          case "warning":
            A(H, "pulse-warning");
        }
      ...
      e.imageUrl
        ? (O.setAttribute("src", e.imageUrl),
          L(O),
          e.imageWidth
            ? O.setAttribute("width", e.imageWidth)
            : O.removeAttribute("width"),
          e.imageHeight
            ? O.setAttribute("height", e.imageHeight)
      ...
      e.showConfirmButton || e.showCancelButton ? L(N) : q(N),
        ...
        e.buttonsStyling &&
          ((s.style.backgroundColor = e.confirmButtonColor),
          (c.style.backgroundColor = e.cancelButtonColor)),
    ...
    Q = function() {
      null === c.previousBodyPadding &&
        ...
        (document.body.style.paddingRight = j() + "px"));
    },
    Y = function() {
      null !== c.previousBodyPadding &&
      ...
      return new Promise(function(e, t) {
        ...
        var o = function(e) {
            switch ((e = e || r.input)) {
              ...
              case "radio":
                return (
                  i.querySelector("." + n.radio + " input:checked") ||
                  i.querySelector("." + n.radio + " input:first-child")
                );
              case "range":
            ...
            d = function(e) {
              ...
              switch (n.type) {
                ...
                case "mouseout":
                  r.buttonsStyling &&
                    (c
                      ? (i.style.backgroundColor = r.confirmButtonColor)
                      : d && (a.style.backgroundColor = r.cancelButtonColor));
                  break;
                case "mousedown":
                  r.buttonsStyling &&
                    (c
                ...
                case "click":
                  c && F.isVisible()
                    ...
                    : d &&
                      F.isVisible() &&
                      (F.closeModal(r.onClose), t("cancel"));
              }
            },
        ...
        (k().onclick = function() {
          ...
          (a.onclick = function(e) {
            e.target === a &&
              r.allowOutsideClick &&
              (F.closeModal(r.onClose), t("overlay"));
          });
        var v = w(),
          h = C();
        r.reverseButtons
          ? v.parentNode.insertBefore(h, v)
          : v.parentNode.insertBefore(v, h);
        var x = function(e, t) {
          ...
          M = function(e) {
            ...
            if ([9, 13, 32, 27].indexOf(o) !== -1) {
              ...
              9 === o
                ...
                : 27 === o &&
                  r.allowEscapeKey === !0 &&
                  (F.closeModal(r.onClose), t("esc"));
            }
          };
        (c.previousWindowKeyDown = window.onkeydown),
          (window.onkeydown = M),
          r.buttonsStyling &&
            ((v.style.borderLeftColor = r.confirmButtonColor),
            (v.style.borderRightColor = r.confirmButtonColor)),
          ...
          (F.hideLoading = F.disableLoading = function() {
            r.showConfirmButton || (q(v), r.showCancelButton || q(y())),
              B(v, n.loading),
              B(i, n.loading),
              (v.disabled = !1),
              (h.disabled = !1);
        ...
        for (
          ...
          if ((O = o(V[N]))) {
            ...
            for (var Q in r.inputAttributes)
              O.setAttribute(Q, r.inputAttributes[Q]);
          }
        ...
        !(function() {
          switch (r.input) {
            ...
            case "tel":
              (O = P(i, n.input)),
                ...
                (O.placeholder = r.inputPlaceholder),
                (O.type = r.input),
                L(O);
              break;
            case "file":
            ...
            case "select":
              ...
              if (((l.innerHTML = ""), r.inputPlaceholder)) {
                ...
                (s.innerHTML = r.inputPlaceholder),
                  (s.value = ""),
                  (s.disabled = !0),
                  (s.selected = !0),
                  l.appendChild(s);
            ...
            case "checkbox":
              ...
              (d.type = "checkbox"),
                (d.value = 1),
                (d.id = n.checkbox),
                (d.checked = Boolean(r.inputValue));
              var p = u.getElementsByTagName("span");
              p.length && u.removeChild(p[0]),
                (p = document.createElement("span")),
                (p.innerHTML = r.inputPlaceholder),
                u.appendChild(p),
                L(u);
              break;
            case "textarea":
              ...
              (f.value = r.inputValue),
                (f.placeholder = r.inputPlaceholder),
                L(f);
              break;
            case null:
              break;
          ...
          "undefined" == typeof MutationObserver ||
            R ||
            ((R = new MutationObserver(F.recalculateHeight)),
            R.observe(i, { childList: !0, characterData: !0, subtree: !0 }));
      });
    },
    F = function e() {
  ...
  return (
    ...
    (F.close = F.closeModal = function(e) {
      ...
      B(r, "animate"),
        B(r.querySelector(".tip"), "animate-success-tip"),
        B(r.querySelector(".long"), "animate-success-long");
      var i = t.querySelector("." + n.icon + "." + o.error);
      B(i, "animate-error-icon"),
        B(i.querySelector(".x-mark"), "animate-x-mark");
    ...
    (F.setDefaults = function(e) {
      if (!e || "object" !== ("undefined" == typeof e ? "undefined" : D(e)))
      ...
      for (var t in e)
        r.hasOwnProperty(t) ||
          "extraParams" === t ||
          (console.warn('SweetAlert2: Unknown parameter "' + t + '"'),
          delete e[t]);
      W(U, e);
    }),
